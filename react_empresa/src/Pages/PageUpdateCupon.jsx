...
function PageUpdateCupon() {
    ...
    useEffect(() => {
        ...
        const obtenerEmpresas = async () => {
            try {
                const response = await axios.get("http://127.0.0.1/proyecto_2_lenguajes/api_php/services/AdmistrativoService.php?empresas");
    ...
    useEffect(() => {
        if (cupon) {
            setValue("codigo", cupon.codigo_cupon);
            setValue("descuento", cupon.porcentaje_cupon);
            setValue("precio", cupon.precio_cupon);
            setValue("fechainicio", cupon.fecha_inicio_cupon);
            setValue("vencimiento", cupon.fecha_vencimiento_cupon);
            setValue("empresa", cupon.id_empresa_cupon);
...
export default PageUpdateCupon;
